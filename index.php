...
<html lang="en">
    ...
    <meta charset="utf-8" />
        ...
        <!-- <link rel="stylesheet" href="modal-02/css/ionicons.min.css"> -->
	    <!-- <link rel="stylesheet" href="modal-02/css/style.css"> -->
	    <!-- Fonts -->
        ...
        <section class="page-section" id="story">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">จุดเริ่มต้นของเว็บไซต์สุ่มตามสั่งของเรา!</h3>
                </div>
                <ul class="timeline">
                    <li>
