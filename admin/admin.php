...
<body id="page-top">
    ...
    <section class="page-section" id="random">
      <div class="container">
            <h3 class="mt-4">ยินดีต้อนรับ Admin, <?php echo $row['firstname'] . ' ' . $row['lastname']?></h3><hr>
        ...
        <div class="row justify-content-center">
          <div class="col-md-11 mt-3">
            <div class="card mb-3">
              ...
              <a href="food_add.php" class="btn btn-success">เพิ่มรายการอาหาร</a>
              </div>
                <div class="card-body">
                  <table id=foodTable class="table table-hover table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th><h5>ประเภท</h5></th>
                        <th><h5>แคลลอรี่</h5></th>
                        <th><h5>รูปภาพ</h5></th>
                        <th><h5>วันเวลาที่สร้าง</h5></th>
                        <th><h5>แก้ไข</h5></th>
                        <th><h5>ลบ</h5></th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      ...
                      ?>
                          ...
                          <tr>
                              ...
                              <td><a href="food_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">แก้ไข</a></td>
                              <td><a href="food_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">ลบ</a></td>
                          </tr>
                      <?php
                          }
                      ?>
    ...
    <section class="page-section" id="memberlists">
      <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase">รายชื่อสมาชิก</h2>
            <h3 class="section-subheading text-muted">รายชื่อสมาชิกทั้งหมดที่ถูกจัดเก็บไว้ในฐานข้อมูล!!</h3>
        </div>
      </div>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-11 mt-3">
            <div class="card mb-3">
              <div class="card-header bg-dark text-white d-flex justify-content-between"><h3>สมาชิกทั้งหมด</h3>
              <a href="member_add.php" class="btn btn-success">เพิ่มรายชื่อสมาชิก</a>
              </div>
                <div class="card-body">
                  <table id=memberTable class="table table-hover table-bordered">
                    ...
                    <tbody>
                      <?php
                          include_once('../config/functions.php');
                          $fetchdata = new DB_con();
                          $sql = $fetchdata->fetchdata_member();
                      ...
                      ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['created_at']?></td>
                            <td><a href="member_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">แก้ไข</a></td>
                            <td><a href="member_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger">ลบ</a></td>
                          </tr>
                      <?php
                          }
                      ?>
